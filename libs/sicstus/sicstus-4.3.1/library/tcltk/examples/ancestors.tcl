...
radiobutton .mother    -text mother    -variable type -representation mother
radiobutton .father    -text father    -variable type -representation father
radiobutton .parents   -text parents   -variable type -representation parents
radiobutton .ancestors -text ancestors -variable type -representation ancestors
