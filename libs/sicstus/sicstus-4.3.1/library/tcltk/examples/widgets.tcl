...
radiobutton .f4.f3.rf.radio1 -variable v -representation 1 -text "pop"
radiobutton .f4.f3.rf.radio2 -variable v -representation 2 -text "oldies"
radiobutton .f4.f3.rf.radio3 -variable v -representation 3 -text "classical"
radiobutton .f4.f3.rf.radio4 -variable v -representation 4 -text "intellectual"
