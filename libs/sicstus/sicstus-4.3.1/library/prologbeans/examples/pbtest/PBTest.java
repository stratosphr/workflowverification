...
public class PBTest implements Runnable {
  ...
  public void shutdown() {
    ...
    static class SessionRunnable implements Runnable {
        public void run() {
                ...
                int query_sleep =
                    Integer.getInteger("pbtest.sleep", 0).intValue();
                    ...
                    if (query_sleep > 0)
                        {
                            ...
                            QueryAnswer a =
                                session.executeQuery("sleep(" + query_sleep + ")", new Bindings());
                            System.err.println("Sleeping query return " + query_sleep + "s");
                        }
  ...
  public static void main(String[] args) throws Exception {
	...
	Integer.getInteger("pbtest.concurrent_sessions", 0).intValue();
    // [PM] 4.1.3 concurrent_sessions > 0 is used for internal SICS testing purposes only.
	...
	fail("Error " + answer.getError(), test);
      ...
      PBTerm eTerm = PBTerm.makeTerm(PBTerm.makeTerm(127), PBTerm.makeTerm(PBTerm.makeTerm(128), PBTerm.makeTerm(PBTerm.makeTerm(129), NIL)));
      PBTerm rTerm = PBTerm.makeTerm(PBTerm.makeTerm(129), PBTerm.makeTerm(PBTerm.makeTerm(128), PBTerm.makeTerm(PBTerm.makeTerm(127), NIL)));
