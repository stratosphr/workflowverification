...
class FastParser {
	...
	/*- [PM] 4.1.3 no longer used
	private PBListCell parseList(InputStream stream) throws IOException {
	...
	// String type = term.isAtom() ? "A " : term.isVariable() ? "V " :
	// term.isCompound() ? "C " : term.isInteger() ? "I " : "? ";
