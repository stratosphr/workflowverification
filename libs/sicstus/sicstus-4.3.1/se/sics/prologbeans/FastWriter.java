...
class FastWriter {
	...
	/*
	 * [PD] 3.12.3 Bogus public void writeString(String value) throws
	 * IOException { initOutput(); output.write(FastParser.STRING); // [PD]
	 * 3.12.2 Strings should not be UTF-8-encoded // // [PD] 3.12.1 Correct
	 * encoding is required to make SICStus happy. //
	 * output.write(value.getBytes(ENCODING));
	 * output.write(value.getBytes("ISO-8859-1")); output.write(0);
	 * output.write(FastParser.NIL); }
	 */
	...
	// System.err.println(" writeCharList(): value.length()==" +
	// value.length());
	// }
	// if (value.length() > 0) {
	...
	/*
	 * [PD] 3.12.3 Bogus public void writeString(String value, Term nextTerm)
	 * throws IOException { initOutput(); output.write(FastParser.STRING); //
	 * [PD] 3.12.2 Strings should not be UTF-8-encoded // // [PD] 3.12.1 Correct
	 * encoding is required to make SICStus happy. //
	 * output.write(value.getBytes(ENCODING));
	 * output.write(value.getBytes("ISO-8859-1")); output.write(0); if (nextTerm
	 * != PBList.NIL) { nextTerm.fastWrite(this); } else {
	 * output.write(FastParser.NIL); } }
	 */
